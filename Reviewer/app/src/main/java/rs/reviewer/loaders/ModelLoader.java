...
public class ModelLoader<T extends Model> extends AsyncTaskLoader<List<T>>
{
			...
			boolean updateOnRelationshipChanges)
	{
		...
		observedTables = new ArrayList<Class<? extends Model>>();
	}
	
	public ModelLoader<T> addObservedTables(List<Class<? extends Model>> observedTables)
	{
		this.observedTables.addAll(observedTables);
		return this;
	}
